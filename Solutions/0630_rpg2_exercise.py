...
spec = importlib.util.spec_from_file_location("RPG1",Path("0620_rpg1_exercise.py"))
module = importlib.util.module_from_spec(spec)
sys.modules["RPG1"] = module
spec.loader.exec_module(module)

class Hunter(module.Character):
    def __init__(self,name,max_health,current_health,attack_power):
        super().__init__(name,max_health,current_health,attack_power)